...
- [agent-board-pizarra](agent-board-pizarra.md) — Opt-in Pizarra widget: Warren/Clara AI proactive messages from news, movers, catalysts, alerts, and Clara savings.
