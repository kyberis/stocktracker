              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-slate-200">
                  ...
                  <tr>
                    ...
                    <td className="py-3 pr-6">AI-powered analysis, chart Q&amp;A, support chat, Warren voice (Telegram), and AID news digests (beta)</td>
                    <td className="py-3 pr-6">
                      Portfolio data included in analysis prompts; chart assistant questions with chart snapshot (values, invested capital, range, trades); support chat messages and optional portfolio summary; voice notes sent to Warren on Telegram (transcribed by OpenAI Whisper, audio not retained); Warren spoken replies generated by OpenAI text-to-speech (audio not retained server-side). When you use the optional AID (Advanced Investor Dashboard) beta, we may send your portfolio tickers and recent news context to generate short bullet summaries shown on /aid.
                    </td>
                  </tr>
                  <tr>
                    <td className="py-3 pr-6">Tavily</td>
                    <td className="py-3 pr-6">Web search for AID earnings-day news digests (beta, optional)</td>
                    <td className="py-3">Stock ticker symbols and search queries derived from your holdings; no account email or name</td>
                  </tr>
                  <tr>
                    <td className="py-3 pr-6">Clara (clara.trefolio.com)</td>
                    <td className="py-3 pr-6">Optional savings summary on AID when you use the same trefolio account</td>
                  ...
                  <tr>
                    ...
                    <td className="py-3 pr-6">Optional recent note tags on AID when you use the same trefolio account</td>
