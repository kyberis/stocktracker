              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-slate-200">
                  ...
                  <tr>
                    ...
                    <td className="py-3 pr-6">AI-powered analysis, chart Q&amp;A, support chat, Warren voice (Telegram), Investor Briefing news digests, FinPulse social summaries (beta), and company analysis (/analisis) narratives</td>
                    <td className="py-3 pr-6">
