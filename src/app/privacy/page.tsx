              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-slate-200">
                  ...
                  <tr>
                    ...
                    <td className="py-3 pr-6">AI-powered analysis, chart Q&amp;A, support chat, Warren voice (Telegram), Investor Briefing news digests, and FinPulse social summaries (beta)</td>
                    <td className="py-3 pr-6">
                      Portfolio data included in analysis prompts; chart assistant questions with chart snapshot (values, invested capital, range, trades); support chat messages and optional portfolio summary; voice notes sent to Warren on Telegram (transcribed by OpenAI Whisper, audio not retained); Warren spoken replies generated by OpenAI text-to-speech (audio not retained server-side). When you use the optional Investor Briefing beta at /aid, we may send your portfolio tickers, recent news context, and excerpts from public X posts to generate short bullet summaries (including FinPulse).
                    </td>
                  </tr>
                  <tr>
                    <td className="py-3 pr-6">Tavily</td>
                    <td className="py-3 pr-6">Web search for Investor Briefing earnings-day news digests and FinPulse X post discovery (beta, optional)</td>
                    <td className="py-3">Stock ticker symbols, curated X handles, and search queries; no account email or name</td>
                  </tr>
                  <tr>
