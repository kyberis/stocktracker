              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-slate-200">
                  ...
                  <tr>
                    ...
                    <td className="py-3 pr-6">AI-powered analysis, chart Q&amp;A, support chat, and Warren voice (Telegram)</td>
                    <td className="py-3 pr-6">
                      Portfolio data included in analysis prompts; chart assistant questions with chart snapshot (values, invested capital, range, trades); support chat messages and optional portfolio summary; voice notes sent to Warren on Telegram (transcribed by OpenAI Whisper, audio not retained); Warren spoken replies generated by OpenAI text-to-speech (audio not retained server-side)
                    </td>
                  </tr>
                  <tr>
