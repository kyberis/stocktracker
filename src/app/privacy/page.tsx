              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-slate-200">
                  ...
                  <tr>
                    ...
                    <td className="py-3 pr-6">AI-powered analysis, chart Q&amp;A, support chat, Warren voice (Telegram), Investor Briefing news digests, FinPulse social summaries (beta), company analysis (/analisis) narratives, Investment Screening research agents (experimental, flag-gated), holding classification Auto-fix (ticker, name, and related metadata sent to suggest sector, region, and asset class), import/portfolio data-quality summaries, and staff-only portfolio anomaly explanations</td>
                    <td className="py-3 pr-6">
