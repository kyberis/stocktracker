    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
          {t("marketInsights") || "Market Insights"}
        </h1>
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">
          {t("marketInsightsSubtitle") || "AI-curated market intelligence from our editorial team"}
        </p>
      </div>
      ...
      {insights.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 dark:text-slate-400 text-sm">No market insights published yet. Check back soon.</p>
        </div>
      ) : (
      ...
      <div className="mt-8 px-4 py-3 rounded-lg bg-gray-50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-800">
        <p className="text-xs text-gray-500 dark:text-slate-500 leading-relaxed">
          {t("marketInsightsDisclaimer") || "These insights are AI-generated and curated by trefolio's editorial team. They are for informational purposes only and do not constitute financial advice. Always do your own research before making investment decisions."}
        </p>
      </div>
    </div>
  );
