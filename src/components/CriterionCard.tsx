...
const CRITERION_EXPLANATIONS: Record<string, string> = {
  ...
  retained_earnings: "Steady growth in retained earnings shows a business that is consistently profitable and finds high-quality reinvestment opportunities. Declines may be explained by aggressive buybacks.",
  return_on_equity: "High ROE means the company efficiently converts reinvested earnings into profit. Buffett's advanced metric: Return on Net Tangible Assets strips out intangibles for a truer picture.",
