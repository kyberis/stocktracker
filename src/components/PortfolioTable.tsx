...
export default function PortfolioTable() {
  ...
  if (holdings.length === 0) {
    return (
      <div className="card text-center py-12">
        <p className="text-slate-400 text-lg">{t("noHoldings")}</p>
      </div>
    );
  }
  ...
  return (
    <div className="card p-0 overflow-hidden">
      ...
      <div className="hidden sm:grid grid-cols-12 gap-2 px-4 py-2 bg-slate-900/50 border-b border-slate-700">
        ...
        <div className="col-span-2 text-right">
          <span className="text-xs text-slate-400">{t("purchasePrice")}</span>
        </div>
        <div className="col-span-2 text-right">
          <span className="text-xs text-slate-400">{t("currentPrice")}</span>
        </div>
        <div className="col-span-2 text-right">
