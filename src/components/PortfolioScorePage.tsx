    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="card p-8 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-slate-400 mb-6">{t("portfolioScoreToolSubtitle")}</p>
          <a
            href="/billing"
            className="inline-block px-6 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl hover:opacity-90 transition-opacity"
          >
