...
const COUNTRY_FLAGS: Record<TaxCountry, string> = { DE: "🇩🇪", FR: "🇫🇷", ES: "🇪🇸", NL: "🇳🇱", IT: "🇮🇹" };
...
export default function TaxReport() {
  ...
  const [country, setCountry] = useState<TaxCountry>(
    () => {
      const residency = user?.taxResidency;
      const upper = (residency || "").toUpperCase() as TaxCountry;
      return TAX_COUNTRIES.includes(upper) ? upper : "DE";
    },
  );
  ...
  }, [taxYear, country, filingStatus, italyRegime]);
