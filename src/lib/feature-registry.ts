...
export const featureDomains: FeatureDomain[] = [
  ...
  },
  {
    ...
    apiRoutes: [
      ...
      { method: "GET", path: "/api/admin/openai-key", auth: "admin", description: "Get AI Gateway key (legacy route id)" },
      { method: "PUT", path: "/api/admin/openai-key", auth: "admin", description: "Set AI Gateway key (legacy route id)" },
    ...
    patterns: [
      ...
      "Operational notifications use a local outbox + cron dispatcher before hitting the external ProdOps Telegram service",
...
export const techStack = [
  ...
  { category: "AI", items: [{ name: "Vercel AI Gateway", version: "", notes: "GPT models for analysis, import extraction, Warren; OpenAI-compatible audio" }] },
