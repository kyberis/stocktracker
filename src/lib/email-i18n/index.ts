...
const en: { welcome: WelcomeStrings; bifolio: BifolioStrings; trefolio: TrefolioStrings } = {
  welcome: {
    ...
    intro: "Hi <strong>{{name}}</strong>, welcome to trefolio &mdash; the extra leaf for your portfolio. Your free Folio account is ready. Here&rsquo;s what you can do right away:",
  ...
  bifolio: {
    ...
    intro: "Congrats, <strong>{{name}}</strong>! Your Bifolio plan is now active. Here&rsquo;s everything you just unlocked:",
...
const es: { welcome: WelcomeStrings; bifolio: BifolioStrings; trefolio: TrefolioStrings } = {
  welcome: {
    ...
    heading: "\u00A1Bienvenido!",
    intro: "Hola <strong>{{name}}</strong>, bienvenido a trefolio &mdash; la hoja extra para tu cartera. Tu cuenta Folio gratuita est&aacute; lista. Esto es lo que puedes hacer:",
  ...
  bifolio: {
    ...
    intro: "Felicidades, <strong>{{name}}</strong>. Tu plan Bifolio ya est&aacute; activo. Esto es lo que has desbloqueado:",
