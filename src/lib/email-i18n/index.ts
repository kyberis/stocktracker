...
const en: { welcome: WelcomeStrings; bifolio: BifolioStrings; trefolio: TrefolioStrings } = {
  welcome: {
    ...
    f3Desc: "A short monthly AI burst on Free (Lite model). Basic and above raise the limit.",
...
const es: { welcome: WelcomeStrings; bifolio: BifolioStrings; trefolio: TrefolioStrings } = {
  welcome: {
    ...
    f3Desc: "Un burst corto de IA al mes en Free (modelo Lite). Basic y superiores suben el l&iacute;mite.",
