...
export const features: Record<string, FeatureTemplateStrings> = {
  "feature-real-time-quotes": {
    ...
    features: [
      {
        title: "60+ p&ouml;rssej&auml;",
        desc: "Hinnat NYSE, NASDAQ, Euronext, Lontoo, Frankfurt ja muilta — powered by Yahoo Finance."
      },
      {
        title: "Automaattinen p&auml;ivitys",
        desc: "Kurssit p&auml;ivittyv&auml;t 15 sekunnin v&auml;lein (asetettavissa 30s tai 60s asetuksissa)."
      },
      {
        title: "Monivaluutta",
  ...
  "feature-dividend-tracking": {
    ...
    features: [
      {
        title: "Dividendikalenteri",
        desc: "N&auml;e tulevat maksut kuukausi kerrallaan. Tied&auml; tarkalleen milloin dividendit saapuvat tilillesi."
      },
      {
        title: "Vuositulot",
        desc: "Kokonaisprojisoitu dividenditulo koko salkustasi osakekohtaisella jakaumalla."
      },
      {
        title: "Tuotto kustannuksille",
        desc: "Seuraa todellista tuottoasi ostohinnan perusteella — ei vain nykyist&auml; dividenditasoa."
      },
      {
        title: "DRIP-simulaatio",
  ...
  "feature-ai-analysis": {
    ...
    features: [
      {
        title: "Tulosanalyysi",
        desc: "\"Miten AAPL:n viimeiset tulokset olivat?\" — yhteenveto tuloksista, ohjeista ja markkinareaktiosta."
      },
      {
        title: "Riskinarviointi",
        desc: "\"Mitä riskejä TSLA:n omistamisessa on?\" — kilpailuuhkat, arvostus ja makrotekijät."
      },
      {
        title: "Kilpailijavertailu",
        desc: "\"Vertaa MSFT vs GOOG\" — rinnakkainen analyysi taloudesta, kasvusta ja arvostuksesta."
      },
      {
        title: "Salkun arviointi",
  ...
  "feature-price-alerts": {
    ...
    features: [
      {
        title: "Kynnyshälyt",
        desc: "Aseta \"ylä\" tai \"ala\" hintatavoitteet. Saa ilmoitus kun osake ylittää linjasi."
      },
      {
        title: "Prosenttimuutos hälyt",
        desc: "Seuraa päivittäisiä tai ostosta prosenttimuutoksia. Nappaa laskut tai nousut varhain."
      },
      {
  ...
  "feature-broker-import": {
    ...
    features: [
      {
        title: "Broker-synkronointi",
        desc: "Yhdistä välittäjäsi ja synkronisoimme automaattisesti positiosi, käteisesi ja tapahtumat. Yhden napsautuksen asennus, aina ajan tasalla."
      },
      {
        title: "CSV-lataus",
        desc: "Vie CSV välittäjältäsi ja lataa se. Tuemme 20+ välittäjäformaattia mukaan lukien DEGIRO, Interactive Brokers, Trade Republic ja muut."
      },
      {
        title: "AI-tuonti",
  ...
  "feature-fundamentals": {
    ...
    features: [
      {
        title: "Tuloslaskelma",
        desc: "Liikevaihto, nettovoitto, marginaalit ja osakekohtainen tulos — neljännesvuosittain ja vuosittain."
      },
      {
        title: "Tase",
        desc: "Vastaa, velat, velkatasot ja kirjanpitoarvo yhdellä silmäyksellä."
      },
      {
        title: "Kassavirta",
        desc: "Liiketoiminta-, sijoitus- ja rahoitusvirrat. Katso tuottaako yritys oikeaa käteistä."
      },
      {
        title: "Insider-kaupat",
        desc: "Katso mitä johtajat ja hallituksen jäsenet ostavat ja myyvät."
      },
      {
        title: "Laitosomistukset",
  ...
  "feature-stock-screener": {
    ...
    features: [
      {
        title: "6 suodatin ulottuvuutta",
        desc: "Markkina-arvo, P/E-suhde, osinkotuotto, toimiala, maa ja p&ouml;rssi. Yhdist&auml; niin monta kuin haluat."
      },
      {
        title: "5 valmiita strategioita",
        desc: "Arvosijoittaminen, osinkojen kasvu, momentum, laatu ja pienet yhti&ouml;t — yhden napsautuksen esiasetukset."
      },
      {
        title: "Rikas data",
        desc: "Hinta, muutos %, markkina-arvo, P/E, osinkotuotto ja toimiala jokaiselle tulokselle."
      },
      {
        title: "Pika lis&auml;ys",
  ...
  "feature-tax-reports": {
    ...
    features: [
      {
        title: "5 EU-maata",
        desc: "Maakohtaiset raportit Saksalle, Ranskalle, Espanjalle, Alankomille ja It&auml;lle."
      },
      {
        title: "Voitot ja tappiot",
        desc: "Lasketut p&auml;&auml;omat voitot, tappiot ja omistusjakso jokaiselle positiolle."
      },
      {
        title: "Osinkotulot",
        desc: "Brutto-osingot, l&auml;hdevero ja nettotuotot alkuper&auml;maan mukaan."
      },
      {
        title: "AI Veroneuvoja",
  ...
  "feature-portfolio-simulator": {
    ...
    features: [
      {
        title: "Backtest",
        desc: "Katso miten salkku olisi menestynyt historiallisesti. Vertaa S&P 500, MSCI World tai mukautettuun vertailuindeksiin."
      },
      {
        title: "Stressitestaus",
        desc: "Mitä jos markkinat putoavat 30%? Entä nousevat korot? Katso miten salkkusi kestää eri skenaarioissa."
      },
      {
        title: "What-if-analyysi",
  ...
  "feature-net-worth": {
    ...
    features: [
      {
        title: "Kiinteistöt",
        desc: "Lisää kiinteistöjä nykyisellä arvolla. Päivitä kun markkinaolot muuttuvat."
      },
      {
        title: "Säästötilit",
        desc: "Seuraa käteistä pankeissa eri valuutoissa."
      },
      {
        title: "Eläkkeet ja vakuutukset",
        desc: "Sisällytä eläkerahastot ja henkivakuutukset varallisuuteesi."
      },
      {
        title: "Kokonaisvarallisuus",
  ...
  "feature-crypto": {
    ...
    features: [
      {
        title: "Krypto-koontinäyttö",
        desc: "Hinnat, 24h muutokset, volyymi ja markkina-arvo huippukryptovaluutoille."
      },
      {
        title: "Salkun seuranta",
        desc: "Lisää kryptopositioita osakkeiden rinnalle. Näe yhdenmukainen salkun arvo ja allokaatio."
      },
      {
        title: "Kaaviot ja historia",
        desc: "Hintakaaviot useilla aikaväleillä ja valuuttakurssien päällekkäisyyksillä."
      },
      {
        title: "AI Krypto-analyysi",
