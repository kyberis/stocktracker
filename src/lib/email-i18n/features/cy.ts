...
export const features: Record<string, FeatureTemplateStrings> = {
  "feature-real-time-quotes": {
    ...
    features: [
      {
        title: "60+ cyfnewidfeydd",
        desc: "Prisiau o NYSE, NASDAQ, Euronext, Llundain, Frankfurt a mwy — powered by Yahoo Finance."
      },
      {
        title: "Hunan-adnewyddu",
        desc: "Mae'r dyfynbrisau'n adnewyddu bob 15 eiliad (gellir ei ffurfweddu i 30s neu 60s yn eich gosodiadau)."
      },
      {
        title: "Amldalennau",
  ...
  "feature-dividend-tracking": {
    ...
    features: [
      {
        title: "Calendr dividendau",
        desc: "Gweld taliadau sydd ar ddod fis ar ôl fis. Gwybod yn union pryd mae'r dividendau'n cyrraedd eich cyfrif."
      },
      {
        title: "Incwm blynyddol",
        desc: "Incwm dividendau arfaethedig cyfanswm ar draws eich portffolio cyfan gyda thoriad i lawr fesul stoc."
      },
      {
        title: "Enillion ar gost",
        desc: "Trafodwch eich enillion gwirioneddol yn seiliedig ar bris prynu — nid dim ond y gyfradd dividendau bresennol."
      },
      {
        title: "Simiwleiddio DRIP",
  ...
  "feature-ai-analysis": {
    ...
    features: [
      {
        title: "Dadansoddiad canlyniadau",
        desc: "\"Sut oedd canlyniadau diwethaf AAPL?\" — crynodeb o ganlyniadau, arweiniad ac ymateb y farchnad."
      },
      {
        title: "Asesiad risg",
        desc: "\"Beth yw'r risgiau o ddal TSLA?\" — bygythiadau cystadleuol, gwerthusiad a ffactorau macro."
      },
      {
        title: "Cymhariaeth cystadleuwyr",
        desc: "\"Cymharwch MSFT vs GOOG\" — dadansoddiad ochr wrth ochr o gyllid, twf a gwerthusiad."
      },
      {
        title: "Adolygiad portffolio",
  ...
  "feature-price-alerts": {
    ...
    features: [
      {
        title: "Rhybuddion trothwy",
        desc: "Gosodwch dargedau pris \"uchod\" neu \"isod\". Cael hysbysiad pan fydd stoc yn croesi eich llinell."
      },
      {
        title: "Rhybuddion newid %",
        desc: "Dilyn newidiadau canran dyddiol neu o bryniant. Dal cwympiadau neu godiadau'n gynnar."
      },
      {
        title: "Aml-sianel",
  ...
  "feature-broker-import": {
    ...
    features: [
      {
        title: "Sync Broker",
        desc: "Cysylltwch eich brocer a byddwn yn cydweddu eich meddiannau, arian parod a thrafodion yn awtomatig. Gosod un clic, bob amser yn gyfredol."
      },
      {
        title: "Llwytho CSV",
        desc: "Allforiwch CSV o'ch brocer a llwythwch ef. Rydym yn cefnogi 20+ fformat gan gynnwys DEGIRO, Interactive Brokers, Trade Republic a mwy."
      },
      {
        title: "Mewnforio AI",
  ...
  "feature-fundamentals": {
    ...
    features: [
      {
        title: "Datganiad incwm",
        desc: "Refeniw, incwm net, ymylau ac enillion fesul cyfranddaliad — chwarterol a blynyddol."
      },
      {
        title: "Cydbwysedd",
        desc: "Asedau, rhwymedigaethau, lefelau dyled a gwerth llyfr ar yr olwg gyntaf."
      },
      {
        title: "Llif arian",
        desc: "Llifau gweithredol, buddsoddi a chyllid. Gweld a yw'r cwmni'n cynhyrchu arian go iawn."
      },
      {
        title: "Trafodion mewnol",
        desc: "Gweld beth mae gweithredwyr a chyfarwyddwyr yn prynu a gwerthu."
      },
      {
        title: "Daliadau sefydliadol",
  ...
  "feature-stock-screener": {
    ...
    features: [
      {
        title: "6 dimensiynau hidlydd",
        desc: "Cyfalaf marchnad, cymhareb P/E, cynnyrch cyfranddaliadau, sector, gwlad a masnachfa. Cyfuniwch gymaint ag y dymunwch."
      },
      {
        title: "5 strategaethau mewnol",
        desc: "Buddsoddi mewn gwerth, twf cyfranddaliadau, momentwm, ansawdd a chwmniau bach — gosodiadau un clic."
      },
      {
        title: "Data cyfoethog",
        desc: "Pris, newid %, cyfalaf marchnad, P/E, cynnyrch cyfranddaliadau a sector ar gyfer pob canlyniad."
      },
      {
        title: "Ychwanegu'n gyflym",
  ...
  "feature-tax-reports": {
    ...
    features: [
      {
        title: "5 gwlad yr UE",
        desc: "Adroddiadau sy'n benodol i wlad ar gyfer yr Almaen, Ffrainc, Sbaen, yr Iseldiroedd a'r Eidal."
      },
      {
        title: "Enillion a cholledion",
        desc: "Enillion cyfalaf a gyfrifwyd, colledion a chyfnod dal ar gyfer pob sefyllfa."
      },
      {
        title: "Incwm o gyfranddaliadau",
        desc: "Cyfranddaliadau gros, treth wrth y ffynhonnell ac incwm net yn ôl gwlad tarddiad."
      },
      {
        title: "Cynorthwyydd Treth IA",
  ...
  "feature-portfolio-simulator": {
    ...
    features: [
      {
        title: "Backtest",
        desc: "Gweld sut y byddai portffolio wedi perfformio'n hanesyddol. Cymharwch â S&P 500, MSCI World neu farchnod personol."
      },
      {
        title: "Profion straen",
        desc: "Beth os yw'r farchnad yn cwympo 30%? Beth am gyfraddau sy'n codi? Gweld sut mae eich portffolio'n dal i fyny o dan wahanol senarios."
      },
      {
        title: "Dadansoddiad what-if",
  ...
  "feature-net-worth": {
    ...
    features: [
      {
        title: "Eiddo",
        desc: "Ychwanegwch eiddo gyda gwerth cyfredol. Diweddarwch pan fydd amodau'r farchnad yn newid."
      },
      {
        title: "Cyfrifon cynilo",
        desc: "Dilynwch arian parod mewn banciau ar draws gwahanol arian cyfred."
      },
      {
        title: "Pensiynau ac yswiriant",
        desc: "Cynnwys cronfeydd pensiwn a polisïau yswiriant bywyd yn eich gwerth net."
      },
      {
        title: "Gwerth net cyfanswm",
  ...
  "feature-crypto": {
    ...
    features: [
      {
        title: "Bwrdd crypto",
        desc: "Prisiau, newidiadau 24h, cyfaint a chyfalaf marchnad ar gyfer prif cryptocuron."
      },
      {
        title: "Trafod portffolio",
        desc: "Ychwanegwch safleoedd crypto ochr yn ochr â stociau. Gweld gwerth ac alocasiwn unedig y portffolio."
      },
      {
        title: "Siapiau a hanes",
        desc: "Siapiau prisiau gyda sawl ffrâm amser a throsiadau cyfradd cyfnewid."
      },
      {
        title: "Dadansoddiad crypto IA",
