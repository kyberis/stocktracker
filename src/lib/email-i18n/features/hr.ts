...
export const features: Record<string, FeatureTemplateStrings> = {
    ...
    features: [
      {
        ...
        desc: "Tr&zdot;i&scaron;na kapitalizacija, omjer P/E, prinos dividendi, sektor, dr&zdot;ava i burza. Kombinirajte koliko god &zdot;elite."
      },
      {
        title: "5 ugra&dstrok;enih strategija",
        desc: "Ulaganje u vrijednost, rast dividendi, zamah, kvaliteta i male tvrtke — prednastavbe jednim klikom."
      },
      {
        title: "Bogati podaci",
        desc: "Cijena, promjena %, tr&zdot;i&scaron;na kapitalizacija, P/E, prinos dividendi i sektor za svaki rezultat."
      },
      {
  ...
  "feature-tax-reports": {
    ...
    features: [
      {
        title: "5 zemalja EU",
        desc: "Izvje&scaron;taji specifi&ccaron;ni za dr&zdot;avu za Njema&ccaron;ku, Francusku, &Scaron;panjolsku, Nizozemsku i Italiju."
      },
      {
        title: "Dobici i gubici",
        desc: "Izra&ccaron;unati kapitalni dobici, gubici i razdoblje dr&zdot;anja za svaku poziciju."
      },
      {
