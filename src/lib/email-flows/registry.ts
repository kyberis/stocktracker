...
export const EMAIL_FLOWS: EmailFlow[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        description: "Daily lifecycle-emails cron looks at a 24-hour signup window.",
        cronId: "lifecycle-emails",
    ...
    nodes: [
      {
        ...
        kind: "trigger",
        label: "Signup + 7 days",
        description: "Daily lifecycle-emails cron; 24-hour eligibility window (7–8 days after signup).",
        cronId: "lifecycle-emails",
      ...
      },
      {
        ...
        description: "Daily trial-expiration cron plus check-on-login finds plan_expires_at in the past.",
