...
const en = {
  ...
  thesisReport: {
    ...
    title: "Thesis",
    subtitle:
      "A plain-language look at the business, what looks solid, what does not, and what the market already prices in. Informational — not a buy, sell or hold recommendation.",
    verdict: "Reading",
    gatePass: "looks fine",
    gateFail: "needs watching",
    gateUnknown: "not scored",
    statement: "The core claim",
    variant: "How this differs from the street",
    consensus: "Street view",
    ourView: "From the filings",
    killCriteria: "What would change this reading",
    killGap: "No numeric line in the filings could be bound as a review trigger.",
    premortem: "If this goes wrong",
    conviction: "How firm is this reading",
    horizon: "Time horizon",
    noDraft:
      "We could not finish a written thesis for this name. The filing snapshot below still stands.",
    facts: "The numbers",
    noFacts: "No filing numbers in this packet.",
    factLabels: {
      "EQ:D1": "Free cash flow / net income",
      "EQ:E1": "Net debt / EBITDA",
      "EQ:E2": "Interest coverage",
      "EQ:B1": "Return on invested capital",
      "EQ:B3": "Gross-margin swings",
      "EQ:C1": "Revenue growth (CAGR)",
      "EQ:D7": "Share count / dilution",
      "calc:fwd_pe": "Forward P/E",
      "calc:hist_pe_avg": "Historical P/E",
      "calc:fcf_yield": "FCF yield",
      "calc:moat_score_pct": "Moat score",
      "calc:target_price": "Consensus target",
      "calc:upside_pct": "Target vs last price",
      "calc:pe_current": "P/E (TTM)",
      "calc:drawdown_52w": "Drawdown vs 52-week high",
      "calc:consensus_eps": "Street EPS",
      "calc:consensus_revenue": "Street revenue",
      "calc:thin_liquidity": "Thin liquidity",
    } as Record<string, string>,
    gaps: "Still open",
    noGaps: "No extra open questions listed.",
    insufficientEvidence: "no citable quote yet",
    sectionBusiness: "The business",
    sectionWhatHappened: "What happened",
    sectionStrengths: "What looks solid",
    sectionWeaknesses: "What to watch",
    sectionOutlook: "The next three years",
    sectionInvalidation: "What would change this reading",
    sectionOpen: "Still open",
    sectionNumbers: "See the numbers",
    headlineWatchlistDilution: "On the watchlist: the share count has been rising",
    headlineWatchlistCash: "On the watchlist: cash conversion is weak",
    headlineWatchlistLeverage: "On the watchlist: debt looks high versus earnings",
    headlineWatchlistGeneric: "On the watchlist: a quality check did not pass",
    businessFromIndustry: "{name} ({ticker}) is in {industry}. Public filings are the base of this note.",
    businessFallback: "{name} ({ticker}) — we describe the business from filings when a company profile is missing.",
    gateBusinessOk: "The business is understandable from public materials.",
    gateBusinessFail: "We could not explain the business from the evidence we have.",
    gateCashOk: "Free cash flow is about {value} of reported earnings.",
    gateCashGenerates: "Free cash flow generates {value} of reported earnings.",
    gateCashFail: "Cash conversion is weak — free cash flow is {value} of net income.",
    gateDebtOk: "Net debt is modest at {value}.",
    gateDebtFail: "Net debt is elevated at {value}.",
    coverageLine: "Interest coverage is {adj} at {value}.",
    coverageUnavailable: "Interest coverage is not available.",
    gateDilutionOk: "The share count has not been rising in a material way.",
    gateDilutionFail: "The share count has been rising, so each share is a smaller slice of the business.",
    shareBuyback: "The company has been buying back shares at {cagr} a year ({cumulative} over {years} years).",
    roicOk: "Return on invested capital is healthy at {value}.",
    revenueDown: "Revenue has been shrinking ({value}).",
    outlookUpside: "The published analyst target implies {value} versus the last price.",
    outlookCurrentPe: "The current P/E on TTM earnings is {value}.",
    outlookPe: "Forward P/E is {fwd} versus a {hist} multi-year average.",
    outlookNotGuidance: "Those figures are street consensus, not company-issued guidance.",
    staleTarget: "The consensus target may not reflect the recent drop.",
    mixedPeriod: "Some figures mix trailing-twelve-month and year-end numbers.",
    staleFiling: "Latest audited accounts: {date}.",
    whatHappenedDrawdown: "The share price sits {value} versus its 52-week high.",
    checkStatusPass: "Met",
    checkStatusFail: "Not met",
    checkStatusUnknown: "Insufficient data",
    checkStatusSkipped: "Not applicable",
    checkDataLabel: "What we measured",
    checkMeaningLabel: "How to read it",
    checkInterpretationLabel: "What it means here",
    invalidationLabeled: "Review this reading if {label}.",
    invalidationCash: "Review this reading if free cash flow falls below about 60% of net income.",
    openMoat: "competitive advantage",
    openMgmt: "management tone on earnings calls",
    openInsiders: "insider buying or selling",
    openMix: "how revenue splits across products",
    openNews: "recent media tone",
    openCatalysts: "dated near-term catalysts",
    openQuestionsJoin: ", ",
    openQuestionsTemplate:
      "We did not find a citable quote on {items}. That does not erase the filing numbers; it leaves those parts unfinished.",
    convictionHint: "{value}/5 — this is how complete the note is, not a rating of the stock.",
    horizonHint: "{value} months",
    filingSnapshot: "Filing snapshot {score}/100 — cash, leverage, returns and valuation versus history. Not a buy/sell score.",
    verdicts: {
      high_quality_attractively_priced: "Quality looks solid and the multiple is not stretched versus history",
      high_quality_richly_priced: "Quality looks solid, and the market already pays a full multiple",
      improving_fundamentals: "The filings point to improving fundamentals",
      value_with_open_questions: "The price looks interesting, with open questions still on the table",
      deteriorating: "The filings point to deterioration",
      insufficient_data: "Not enough filing data for a full thesis",
      watchlist_gate_failed: "On the watchlist: a quality check did not pass",
    },
  },
};
...
const es: ScreeningCopy = {
  ...
  thesisReport: {
    ...
    title: "Tesis",
    subtitle:
      "Una lectura en claro del negocio, lo que encaja, lo que no, y lo que el mercado ya descuenta. Informativa: no es una recomendación de inversión.",
    verdict: "Lectura",
    gatePass: "encaja",
    gateFail: "a vigilar",
    gateUnknown: "sin puntuar",
    statement: "La idea central",
    variant: "En qué se aparta del mercado",
    consensus: "Visión de consenso",
    ourView: "Desde las cuentas",
    killCriteria: "Qué cambiaría esta lectura",
    killGap: "No hay una línea numérica en las cuentas que sirva de disparador de revisión.",
    premortem: "Si esto sale mal",
    conviction: "Qué tan firme es esta lectura",
    horizon: "Horizonte",
    noDraft:
      "No pudimos terminar una tesis escrita para este nombre. El resumen de cuentas sigue abajo.",
    facts: "Los números",
    noFacts: "No hay números de cuentas en este paquete.",
    factLabels: {
      "EQ:D1": "Flujo de caja libre / beneficio neto",
      "EQ:E1": "Deuda neta / EBITDA",
      "EQ:E2": "Cobertura de intereses",
      "EQ:B1": "Retorno sobre capital invertido",
      "EQ:B3": "Vaivenes del margen bruto",
      "EQ:C1": "Crecimiento de ingresos (CAGR)",
      "EQ:D7": "Número de acciones / dilución",
      "calc:fwd_pe": "PER a futuro",
      "calc:hist_pe_avg": "PER histórico",
      "calc:fcf_yield": "Rentabilidad FCF",
      "calc:moat_score_pct": "Puntuación de foso",
      "calc:target_price": "Precio objetivo de consenso",
      "calc:upside_pct": "Objetivo vs último precio",
      "calc:pe_current": "PER (TTM)",
      "calc:drawdown_52w": "Caída vs máximo 52 semanas",
      "calc:consensus_eps": "BPA de consenso",
      "calc:consensus_revenue": "Ingresos de consenso",
      "calc:thin_liquidity": "Liquidez baja",
    } as Record<string, string>,
    gaps: "Sigue abierto",
    noGaps: "Sin preguntas abiertas extra.",
    insufficientEvidence: "aún sin cita",
    sectionBusiness: "El negocio",
    sectionWhatHappened: "Qué ha pasado",
    sectionStrengths: "Lo que encaja",
    sectionWeaknesses: "Lo que hay que vigilar",
    sectionOutlook: "Los próximos tres años",
    sectionInvalidation: "Qué cambiaría esta lectura",
    sectionOpen: "Sigue abierto",
    sectionNumbers: "Ver los números",
    headlineWatchlistDilution: "En observación: el número de acciones ha subido",
    headlineWatchlistCash: "En observación: la conversión de caja es débil",
    headlineWatchlistLeverage: "En observación: la deuda es alta frente a los beneficios",
    headlineWatchlistGeneric: "En observación: un chequeo de calidad no se cumple",
    businessFromIndustry: "{name} ({ticker}) opera en {industry}. Esta nota se apoya en las cuentas públicas.",
    businessFallback: "{name} ({ticker}) — describimos el negocio con las cuentas cuando falta el perfil de la empresa.",
    gateBusinessOk: "El negocio se entiende a partir de materiales públicos.",
    gateBusinessFail: "No pudimos explicar el negocio con la evidencia que tenemos.",
    gateCashOk: "El flujo de caja libre es unas {value} del beneficio publicado.",
    gateCashGenerates: "El flujo de caja libre genera {value} el beneficio contable.",
    gateCashFail: "La conversión de caja es débil: el flujo de caja libre es {value} del beneficio neto.",
    gateDebtOk: "La deuda neta es moderada, {value}.",
    gateDebtFail: "La deuda neta es elevada, {value}.",
    coverageLine: "La cobertura de intereses es {adj} ({value}).",
    coverageUnavailable: "La cobertura de intereses no está disponible.",
    gateDilutionOk: "El número de acciones no ha subido de forma material.",
    gateDilutionFail: "El número de acciones ha subido, así que cada acción es una porción menor del negocio.",
    shareBuyback: "La empresa recompra un {cagr} anual ({cumulative} acumulado en {years} años).",
    roicOk: "El retorno sobre capital invertido es sano, {value}.",
    revenueDown: "Los ingresos han venido cayendo ({value}).",
    outlookUpside: "El precio objetivo publicado implica {value} frente al último precio.",
    outlookCurrentPe: "El PER actual sobre el BPA TTM es {value}.",
    outlookPe: "El PER a futuro es {fwd} frente a una media de {hist} en varios años.",
    outlookNotGuidance: "Esas cifras son consenso de analistas, no una guía de la empresa.",
    staleTarget: "El objetivo de consenso puede no recoger la caída reciente.",
    mixedPeriod: "Mezcla datos TTM y de cierre anual.",
    staleFiling: "Últimas cuentas auditadas: {date}.",
    whatHappenedDrawdown: "El precio cotiza {value} frente a su máximo de 52 semanas.",
    checkStatusPass: "Cumple",
    checkStatusFail: "No cumple",
    checkStatusUnknown: "Datos insuficientes",
    checkStatusSkipped: "No aplica",
    checkDataLabel: "Qué medimos",
    checkMeaningLabel: "Cómo leerlo",
    checkInterpretationLabel: "Qué significa aquí",
    invalidationLabeled: "Conviene revisar esta lectura si {label}.",
    invalidationCash: "Conviene revisar esta lectura si el flujo de caja libre cae por debajo de unos 60% del beneficio neto.",
    openMoat: "la ventaja competitiva",
    openMgmt: "el tono de la dirección en las conference calls",
    openInsiders: "compras o ventas de insiders",
    openMix: "cómo se reparte el ingreso entre productos",
    openNews: "el tono reciente de los medios",
    openCatalysts: "catalizadores cercanos con fecha",
    openQuestionsJoin: ", ",
    openQuestionsTemplate:
      "No encontramos una cita sobre {items}. Eso no borra los números de las cuentas; deja esas partes sin cerrar.",
    convictionHint: "{value}/5 — mide lo completa que está la nota, no es una nota del valor.",
    horizonHint: "{value} meses",
    filingSnapshot: "Resumen de cuentas {score}/100 — caja, deuda, retornos y valoración frente a la historia. No es un consejo de inversión.",
    verdicts: {
      high_quality_attractively_priced: "La calidad se ve sólida y el múltiplo no está estirado frente a la historia",
      high_quality_richly_priced: "La calidad se ve sólida y el mercado ya paga un múltiplo completo",
      improving_fundamentals: "Las cuentas apuntan a fundamentales en mejora",
      value_with_open_questions: "El precio llama la atención, con preguntas aún abiertas",
      deteriorating: "Las cuentas apuntan a un deterioro",
      insufficient_data: "No hay datos de cuentas suficientes para una tesis completa",
      watchlist_gate_failed: "En observación: un chequeo de calidad no se cumple",
    },
  },
};
