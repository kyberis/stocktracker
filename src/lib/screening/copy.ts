...
const en = {
  ...
  report: {
    ...
    categoryCheapHint:
      "Relative valuation vs its own P/E history (and absolute bands). Red means little margin of safety — not that the business is bad.",
    categoryFitHint:
      "How the name sits with your risk profile and concentration. Amber means it can fit, but it stretches your limits.",
    categorySolidityHint:
      "Business quality (MOAT) plus financial strength (net debt / EBITDA, net cash). Color is for this axis only.",
    cheapLabels: {
      cheap: "Cheap",
      fair: "Fair price",
      expensive: "Expensive vs history",
      unknown: "No valuation data",
    },
    cheapPeDetail: "P/E {current} vs hist. {hist}",
    cheapPeCurrentOnly: "P/E {current}",
    fitLabels: {
      fit: "Fits",
      stretch: "Tight fit / stretches profile",
      poor_fit: "Poor fit",
      unknown: "No fit data",
    },
    solidityLabels: {
      ...
      moderate: "Moderate",
      weak: "Weak",
      unknown: "No MOAT or leverage data",
    },
    solidityMoatDetail: "MOAT {score}/100",
    solidityFundDetailNd: "ND/EBITDA {nd}",
    solidityFundDetailCash: "Net cash",
    solidityFundDetailNdCash: "ND/EBITDA {nd} · net cash",
    ...
    evaluationMoat: "Moat",
    evaluationManagement: "Management",
    evaluationFinancials: "Financials",
    evaluationGrowth: "Growth",
    evaluationValuation: "Valuation",
    evaluationCatalysts: "Catalysts",
    evaluationRisks: "Risks & pre-mortem",
    evaluationInvalidation: "What invalidates the thesis",
    evaluationGaps: "Information gaps",
    evaluationConviction: "Conviction",
    evaluationPass: "PASS",
    evaluationDiscard: "DISCARD",
    unmetBriefTitle: "Brief expectations not met",
    unmetBriefHint: "This name met {met} of {total} evaluable filters — missing:",
    risksTitle: "Risks",
    sourcesToggle: "References ({n})",
    metaPrice: "Price",
    metaTarget: "Target",
    metaFwdPe: "Fwd P/E",
    metaPe: "P/E",
    ...
    range52wLow: "Low",
    range52wHigh: "High",
    range52wTitle: "52-week range",
    range52wPriceChange: "Price change",
    range52wAria:
      "52-week range: low {low}, high {high}, current {price}, at {pct}% of the range",
    ...
    priceChart1y: "1Y",
    priceChart5y: "5Y",
    priceChartNoData: "Price history is not available for this ticker.",
    metaTrend: "Trend",
    ...
    suitabilityFit: "Fit",
    suitabilityStretch: "Tight fit / stretches profile",
...
const es: ScreeningCopy = {
  ...
  report: {
    ...
    categoryCheapHint:
      "Valoración relativa a su propio PER histórico (y bandas absolutas). Rojo = poco margen de seguridad — no significa que el negocio sea malo.",
    categoryFitHint:
      "Encaje con tu perfil de riesgo y concentración. Ámbar = puede entrar, pero aprieta tus límites.",
    categorySolidityHint:
      "Calidad del negocio (MOAT) más fortaleza financiera (deuda neta/EBITDA, caja neta). El color es solo de este eje.",
    cheapLabels: {
      cheap: "Barata",
      fair: "Precio justo",
      expensive: "Cara vs su historia",
      unknown: "Sin datos de valoración",
    },
    cheapPeDetail: "PER {current} vs hist. {hist}",
    cheapPeCurrentOnly: "PER {current}",
    fitLabels: {
      fit: "Encaja",
      stretch: "Justo / fuerza el perfil",
      poor_fit: "Mal encaje",
      unknown: "Sin datos de encaje",
    },
    solidityLabels: {
      solid: "Sólida",
      moderate: "Moderada",
      weak: "Débil",
      unknown: "Sin MOAT ni datos de deuda",
    },
    solidityMoatDetail: "MOAT {score}/100",
    solidityFundDetailNd: "ND/EBITDA {nd}",
    solidityFundDetailCash: "Caja neta",
    solidityFundDetailNdCash: "ND/EBITDA {nd} · caja neta",
    ...
    evaluationMoat: "Moat",
    evaluationManagement: "Directiva",
    evaluationFinancials: "Números",
    evaluationGrowth: "Crecimiento",
    evaluationValuation: "Valoración",
    evaluationCatalysts: "Catalizadores",
    evaluationRisks: "Riesgos y pre-mortem",
    evaluationInvalidation: "Qué invalida la tesis",
    evaluationGaps: "Lagunas de información",
    evaluationConviction: "Convicción",
    evaluationPass: "PASA",
    evaluationDiscard: "DESCARTE",
    ...
    range52wLow: "Mínimo",
    range52wHigh: "Máximo",
    range52wTitle: "Rango 52 s.",
    range52wPriceChange: "Variación en el precio",
    range52wAria:
      "Rango 52 semanas: mínimo {low}, máximo {high}, actual {price}, al {pct}% del rango",
    priceChartTitle: "Evolución del precio",
    priceChart1w: "1S",
    priceChart1m: "1M",
    priceChart3m: "3M",
    priceChart6m: "6M",
    priceChart1y: "1A",
    priceChart5y: "5A",
    priceChartNoData: "No hay historial de precio para este ticker.",
    metaTrend: "Tendencia",
    ...
    suitabilityStretch: "Justo / fuerza el perfil",
