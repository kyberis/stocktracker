...
const en = {
  ...
  thesisReport: {
    ...
    noFacts: "No filing facts in this packet.",
    factLabels: {
      "EQ:D1": "FCF / net income",
      "EQ:E1": "Net debt / EBITDA",
      "EQ:E2": "Interest coverage",
      "EQ:B1": "ROIC",
      "EQ:B3": "Gross-margin volatility",
      "EQ:C1": "Revenue CAGR",
    ...
    gaps: "Not scored from a filing quote",
    noGaps: "No listed gaps.",
    insufficientEvidence:
      "no filing quote for this check (FMP numbers are still listed above)",
    verdicts: {
...
const es: ScreeningCopy = {
  ...
  thesisReport: {
    ...
    facts: "Hechos publicados",
    noFacts: "No hay hechos de cuentas en este paquete.",
    factLabels: {
      "EQ:D1": "FCF / beneficio neto",
      "EQ:E1": "Deuda neta / EBITDA",
      "EQ:E2": "Cobertura de intereses",
      "EQ:B1": "ROIC",
      "EQ:B3": "Volatilidad del margen bruto",
      "EQ:C1": "CAGR de ingresos",
      "EQ:D7": "Acciones / dilución",
    ...
    gaps: "Sin puntuar por falta de cita de un informe",
    noGaps: "Sin huecos listados.",
    insufficientEvidence:
      "sin cita de un informe para este chequeo (los números FMP siguen arriba)",
    verdicts: {
