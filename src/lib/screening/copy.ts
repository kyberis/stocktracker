...
const en = {
  ...
  thesisReport: {
    ...
    gateCashOk: "Free cash flow covers reported earnings (about {value}× net income).",
    gateCashFail: "Cash conversion is weak — free cash flow is about {value}× net income.",
    gateDebtOk: "Net debt is modest at about {value}× EBITDA.",
    gateDebtFail: "Net debt is elevated at about {value}× EBITDA.",
    gateCoverageOk: "Earnings cover interest about {value} times.",
    gateCoverageFail: "Interest coverage is thin at about {value} times.",
    ...
    roicOk: "Return on invested capital is healthy at about {value}%.",
    revenueDown: "Revenue has been shrinking (about {value}% a year in the published series).",
    outlookUpside: "The published analyst target implies about {value}% versus the last price.",
...
const es: ScreeningCopy = {
  ...
  thesisReport: {
    ...
    gateCashOk: "El flujo de caja libre cubre el beneficio publicado (unas {value}× el beneficio neto).",
    gateCashFail: "La conversión de caja es débil: el flujo de caja libre es unas {value}× el beneficio neto.",
    gateDebtOk: "La deuda neta es moderada, unas {value}× el EBITDA.",
    gateDebtFail: "La deuda neta es elevada, unas {value}× el EBITDA.",
    gateCoverageOk: "El beneficio cubre los intereses unas {value} veces.",
    gateCoverageFail: "La cobertura de intereses es justa, unas {value} veces.",
    ...
    roicOk: "El retorno sobre capital invertido es sano, alrededor del {value}%.",
    revenueDown: "Los ingresos han venido cayendo (unos {value}% al año en la serie publicada).",
    outlookUpside: "El precio objetivo publicado implica unos {value}% frente al último precio.",
